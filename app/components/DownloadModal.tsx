  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className="relative w-full max-w-lg rounded-3xl bg-linear-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90 p-6 sm:p-8 shadow-2xl backdrop-blur-xl border border-gray-700"
            ...
            {showAd ? (
              <div className="flex flex-col items-center w-full text-center">
                ...
                <p className="text-sm sm:text-base text-gray-300 mb-4">
                  Please watch this ad to unlock your download preview.
                </p>
              ...
              <div className="flex flex-col items-center w-full text-center">
                ...
                <p className="text-sm sm:text-base text-gray-300 mb-6">
                  You can now safely download <span className="font-semibold text-gray-50">{gamename}</span>.
                </p>
